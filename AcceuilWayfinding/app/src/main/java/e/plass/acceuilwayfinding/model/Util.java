...
public class Util {
    ...
    public Util() {
        ...
        ,new LatLng( 2.926802, 11.157631 )));

        c.set(2010,01,01);
        ecoles.add(new Ecole(7,8f,"Ecole Supérieure des Travaux Publics","estp", c,"Buea","",""
        ,"L’ENSTP assure la formation initiale des techniciens supérieur , des techniciens (niveau BAC et probatoire) à Buéa."
        ,new LatLng( 3.869975, 11.497054 )));
